...
class Measurement:
    def __init__(self, title, timestamp, current_arrays, potential_arrays, time_arrays, freq_arrays, zre_arrays, zim_arrays, aux_input_arrays, peaks, eis_fit, dotnet_measurement = None):
        self.Title = title
